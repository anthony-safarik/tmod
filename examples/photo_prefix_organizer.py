...
def find_dsc_files(directory, prefix):
    matches = []
...
def main():
    parser = argparse.ArgumentParser(description="Find files with prefix and rename based on dated folder.")
    parser.add_argument("directory", help="Directory to search")
    parser.add_argument("target", help="Path to the target directory")
    parser.add_argument("prefix", help="File prefix filter")
    args = parser.parse_args()

    PREFIX = "StillCamera"

    matches = find_dsc_files(args.directory, args.prefix)
